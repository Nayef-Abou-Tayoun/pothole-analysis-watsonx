...
def create_sr_from_analysis(
    ...
    # Create detailed description - AI summary already includes relevant Toronto information
    details = f"""{summary}
...
Note: Analysis includes Toronto pothole repair criteria and timelines where applicable."""
